        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_examDate != null) _buildExamCountdownBanner(),
              if (_examDate != null) const SizedBox(height: 12),
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Expanded(
                child: Text(_mode.bannerMessage,
          ...
          ...rows.map((row) => Container(
                ...
                child: Row(children: [
                  Container(
                      ...
                      decoration: BoxDecoration(
                          color:
                              (row['color'] as Color).withOpacity(0.15),
                          shape: BoxShape.circle),
                      child: Icon(row['icon'] as IconData,
                          color: row['color'] as Color, size: 18)),
                  const SizedBox(width: 12),
                  Expanded(
